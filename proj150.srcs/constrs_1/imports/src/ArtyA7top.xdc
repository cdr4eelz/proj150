...
# set_false_path -from [get_clocks clk_pll_i]                 -to [get_clocks clk_mig_167MHz_clk_wiz_0]
...
#set_false_path -from [get_clocks clk_pll_i               ]   -to [get_clocks clk_mig_167MHz_clk_wiz_0]
#set_false_path -from [get_clocks clk_mig_167MHz_clk_wiz_0]   -to [get_clocks clk_pll_i]
#set_false_path -from [get_clocks sys_clk_pin             ]   -to [get_clocks clk_mig_167MHz_clk_wiz_0]
#set_false_path -from [get_clocks clk_mig_167MHz_clk_wiz_0]   -to [get_clocks sys_clk_pin]
